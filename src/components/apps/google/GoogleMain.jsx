...
import imgLoupe from "../../static/svg/detective-loupe-magnifying-glass-svgrepo-com.svg"
      ...
      <main className="googleApp">
        <section className="googleApp__content">
          ...
          <div className="googleApp__content__serch">
            <Serch placeholder={"Busca en Google o escribe una URL"} img={imgLoupe} use={"serchMain"}/>
          </div>
        </section>
      </main>
    </Google>
